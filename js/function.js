...
$(document).on('ready', function () {
    ...
    $('.other-menu').on('mouseenter', function () {
     ...
     // JavaScript Document
   var today = new Date();
   var target = new Date('11/28/2019 12:26:00'); //Enter Target date & time - MM/DD/YYYY hh:mm:ss
   var startdate = new Date('11/14/2019'); //Enter Timer start date or Today's date - MM/DD/YYYY
   ...
   if ($.find('#example').length) {
       $('#example').countdown({
           date: '11/28/2019 12:26:00', //Enter Target date & time - MM/DD/YYYY hh:mm:ss
           offset: +5.5,
           day: 'Day',
           days: 'Days'
       }, function () {
